...
<head>
    ...
    <!-- Move SweetAlert2 script to head -->
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                        <?php
                        if (isset($full_name)) {
                            echo isset($full_name) ? '<i class="far fa-circle-user"></i> '.  $full_name : 'ACCOUNT';
                        } else {
                            echo "ACCOUNT";
                        }
                        ?>
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="chitietaccount.php">Thông tin tài khoản</a></li>
                        <li><a href="chitietaccount.php">Thông tin vé </a></li>
                        <li><a onclick="confirmLogout()" href="#">Đăng Xuất</a></li>
                        <script>
