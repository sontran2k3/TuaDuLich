    ...
    <div class="row">
        <div class="col-3">
            <nav id="navbar-example3" class="h-100 flex-column align-items-stretch pe-4 border-end">
                <nav class="nav nav-pills flex-column">
                    <a class="nav-link"  href="test.php"> <i class="fa-solid fa-user-pen"></i>  Thông tin tài khoản</a>
                    <a class="nav-link" href="test00.php"> <i class="fa-solid fa-clock-rotate-left"></i>  Lịch sử</a>
                    <a class="nav-link" href="test01.php">  <i class="fa-solid fa-arrow-right-from-bracket"></i>  Logout</a>
                </nav>
            </nav>
        </div>
        ...
        <div class="col-9">
            <div class="col-7">
                ...
                <center><h3>TOUR TRONG NƯỚC</h3></center>
                <form  method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="mota" name="mota" rows="3"
                                  placeholder="Nhập mô tả ảnh" required></textarea>
                    </div>
                    <div class="mb-3">
