...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    if (empty($error)) {
        ...
        if (move_uploaded_file($_FILES['image']['tmp_name'], $target_file)) {
            ...
            $sql = "INSERT INTO tourngoainuoc (title, mota, thoigiandi, thoigianve, soluongkhach, giatien, trangthai, ghichu, image_path) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
...
<div class="container text-top">
    <div class="row">
        ...
        <div class="col-7">
            <center><h3>THÔNG TIN CHI TIẾT TOUR NGOÀI NƯỚC</h3></center>
    ...
    <table class="table table-bordered mt-3">
        ...
        $result = $conn->query("SELECT * FROM tourngoainuoc");
